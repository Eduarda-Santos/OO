    ...
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            if (opcao == 2) { //Menu da pessoa
                ...
                switch (opcao) {
                    case 1:
                        System.out.println("Deseja cadastrar conta com pessoa existente?");
                        System.out.println("1 - SIM");
                        System.out.println("2 - NÃO");
                        resposta =  scan.nextInt();
                        
                        if(resposta == 1){
                            banco.imprimirPessoas();
                            //System.out.println("imprimindo pessoas");
                        }

                        scan.nextLine();
                        System.out.println("Digite o cpf da pessoa que deseja associar a conta:");
                        cpfresposta =  scan.next();
                        pessoa.buscarPessoas(cpfresposta);
